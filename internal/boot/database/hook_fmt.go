...
//
// 	if ok {
// 		fmt.Printf("[TIME] %s"+colorSQL+" [SQL] %s"+colorReset+"  "+colorTime+"[DURATION] %v"+colorReset+"\n", time.Now().Format("2006-01-02 15:04:05"), sql, time.Since(begin))
// 	}
// 	return ctx, nil
// }
